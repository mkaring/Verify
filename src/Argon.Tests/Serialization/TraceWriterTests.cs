...
[
  ...
  ""$values"": [
    ...
    {
      ""$type"": ""TestObjects.VersionOld, Argon.Tests"",
      ""Major"": 1,
      ""Minor"": 2,
      ""Build"": 3,
      ""Revision"": 4,
      ...
      ""MinorRevision"": 4
        ...
        Assert.Equal("Resolved type 'TestObjects.VersionOld, Argon.Tests' to TestObjects.VersionOld. Path '$values[1].$type', line 9, position 52.", traceWriter.TraceRecords[5].Message);
