...
public class TypeNameHandlingTests : TestFixtureBase
{
    ...
    public void SerializeMultidimensionalByteArrayWithTypeName()
    {
        ...
        var expectedJson = $@"{{
  ""$type"": ""TestObjects.HasMultidimensionalByteArray, Argon.Tests"",
  ""Array2D"": {{
    ""$type"": ""{array2dRef}"",
    ""$values"": [
      [
  ...
  ""ReadOnlyDictionary"": {
    ...
    public void DictionaryAuto()
    {
        ...
        XUnitAssert.AreEqualNormalized(@"{
  ""movie"": {
    ""$type"": ""TestObjects.Movie, Argon.Tests"",
    ""Name"": ""Die Hard"",
    ""Description"": null,
    ""Classification"": null,
    ""Studio"": null,
        ...
        XUnitAssert.AreEqualNormalized(@"[
  {
    ...
    public void SerializeRootTypeNameIfDerivedWithAuto()
    {
        ...
        XUnitAssert.AreEqualNormalized(@"{
  ""$type"": ""TestObjects.WagePerson, Argon.Tests"",
  ""HourlyWage"": 0.0,
  ""Name"": null,
  ...
  ""LastModified"": ""0001-01-01T00:00:00""
    ...
    public void SerializeRootTypeNameAutoWithJsonConvert_Generic2()
    {
        ...
        XUnitAssert.AreEqualNormalized(@"{""$type"":""TestObjects.WagePerson, Argon.Tests"",""HourlyWage"":0.0,""Name"":null,""BirthDate"":""0001-01-01T00:00:00"",""LastModified"":""0001-01-01T00:00:00""}", json);
    }
...
""CorrelationId"": ""xyz""
  ...
  ""Name"": ""Name!""
    ...
    {
        var binder = new TypeNameSerializationBinder("Argon.Argon.Tests.Serialization.{0}, Argon.Tests");
  ...
  },
  {
    ...
    ""Quantity"": 1
        ...
        var newValues = JsonConvert.DeserializeObject<IList<object>>(
            ...
            {
                TypeNameHandling = TypeNameHandling.Auto,
                SerializationBinder = new TypeNameSerializationBinder("TypeNameHandlingTests+{0}, Argon.Tests")
            });
    ...
    {
        var binder = new NewTypeNameSerializationBinder("Argon.Argon.Tests.Serialization.{0}, Argon.Tests");
  ...
  },
  {
    ...
    ""Quantity"": 1
        ...
        {
            TypeNameHandling = TypeNameHandling.Auto,
            SerializationBinder = new NewTypeNameSerializationBinder("TypeNameHandlingTests+{0}, Argon.Tests")
        });
  ...
  ""AThirdTestMember"": {{
    ...
    public void WriteObjectTypeNameForPropertyDemo()
    {
        ...
        //   "Address": "http://www.google.com",
        //   "Body": {
        //     "$type": "Argon.Argon.Tests.Serialization.SearchDetails, Argon.Tests",
        //     "Query": "Json.NET",
        //     "Language": "en-us"
        //   }
        // }
  ...
  3
    ...
    public void TypeNameComponentList()
    {
        ...
        XUnitAssert.AreEqualNormalized(@"[
  {
    ""$type"": ""TestObjects.TestComponentSimple, Argon.Tests"",
    ""MyProperty"": 0
  },
  {
    ""$type"": ""TestObjects.Employee, Argon.Tests"",
    ""FirstName"": null,
    ""LastName"": null,
  ...
  ""Data"": {
    ...
    ""two"": {
      ""$type"": ""TypeNameHandlingTests+DynamicDictionary, Argon.Tests"",
      ""one"": {
        ""MyProperty"": 2
      }
    }
  ...
  ""k1"": ""a6e986df-fc2c-4906-a1ef-9492388f7833""
    ...
    public void ExistingBaseValue()
    {
        var json = @"{
    ""itemIdentifier"": {
        ""$type"": ""TypeNameHandlingTests+ReportItemKeys, Argon.Tests"",
        ""dataType"": 0,
        ""wantedUnitID"": 1,
        ""application"": 3,
        ""id"": 101,
