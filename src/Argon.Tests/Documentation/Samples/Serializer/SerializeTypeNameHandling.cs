...
public class SerializeTypeNameHandling : TestFixtureBase
{
    ...
    public void Example()
    {
        ...
        // {
        //   "$type": "Argon.Samples.Stockholder, Argon.Tests",
        //   "FullName": "Steve Stockholder",
        //   "Businesses": {
        //     "$type": "System.Collections.Generic.List`1[[Argon.Samples.Business, Argon.Tests]], mscorlib",
        //     "$values": [
        //       {
        //         "$type": "Argon.Samples.Hotel, Argon.Argon.Tests",
        //         "Stars": 4,
        //         "Name": "Hudson Hotel"
        //       }
        //     ]
